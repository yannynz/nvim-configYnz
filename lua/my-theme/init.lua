...
local function set_groups()
	...
	local diff_add = utils.shade(colors.fg, 0.5, colors.fg)
	...
	local groups = {
		...
		DiffAdd = { bg = config.bg, fg = diff_add },
		DiffChange = { bg = config.bg, fg = diff_change },
		...
		VertSplit = { fg = colors.border, bg = config.bg },
		Winseparator = { link = "VertSplit" },
		SignColumn = { link = "Normal" },
		Folded = { fg = colors.fg, bg = config.bg },
		...
		StatusLine = { fg = colors.fg, bg = config.bg },
